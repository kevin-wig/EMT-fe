    ...
    if (match.params.id && match.params.id !== "create") {
      getTripById(match.params.id).then((res) => {
        formik.setValues({
          ...
          freightProfit: !isNaN(parseFloat(res.data?.freightProfit)) && !isNaN(res.data?.freightProfit - 0) ? parseFloat(Number(res.data?.freightProfit)?.toFixed(2)) : res.data?.freightProfit,
          bunkerCost: !isNaN(parseFloat(res.data?.bunkerCost)) && !isNaN(res.data?.bunkerCost - 0) ? parseFloat(Number(res.data?.bunkerCost)?.toFixed(2)) : res.data?.bunkerCost,
          mgo: !isNaN(parseFloat(res.data?.mgo)) && !isNaN(res.data?.mgo - 0) ? parseFloat(Number(res.data?.mgo)?.toFixed(2)) : res.data?.mgo,
          lfo: !isNaN(parseFloat(res.data?.lfo)) && !isNaN(res.data?.lfo - 0) ? parseFloat(Number(res.data?.lfo)?.toFixed(2)) : res.data?.lfo,
          hfo: !isNaN(parseFloat(res.data?.hfo)) && !isNaN(res.data?.hfo - 0) ? parseFloat(Number(res.data?.hfo)?.toFixed(2)) : res.data?.hfo,
          vlsfoXB: !isNaN(parseFloat(res.data?.vlsfoXB)) && !isNaN(res.data?.vlsfoXB - 0) ? parseFloat(Number(res.data?.vlsfoXB)?.toFixed(2)) : res.data?.vlsfoXB,
          vlsfoAD: !isNaN(parseFloat(res.data?.vlsfoAD)) && !isNaN(res.data?.vlsfoAD - 0) ? parseFloat(Number(res.data?.vlsfoAD)?.toFixed(2)) : res.data?.vlsfoAD,
          vlsfoEK: !isNaN(parseFloat(res.data?.vlsfoEK)) && !isNaN(res.data?.vlsfoEK - 0) ? parseFloat(Number(res.data?.vlsfoEK)?.toFixed(2)) : res.data?.vlsfoEK,
          lpgPp: !isNaN(parseFloat(res.data?.lpgPp)) && !isNaN(res.data?.lpgPp - 0) ? parseFloat(Number(res.data?.lpgPp)?.toFixed(2)) : res.data?.lpgPp,
          lpgBt: !isNaN(parseFloat(res.data?.lpgBt)) && !isNaN(res.data?.lpgBt - 0) ? parseFloat(Number(res.data?.lpgBt)?.toFixed(2)) : res.data?.lpgBt,
          lng: !isNaN(parseFloat(res.data?.lng)) && !isNaN(res.data?.lng - 0) ? parseFloat(Number(res.data?.lng)?.toFixed(2)) : res.data?.lng,
          bioFuel: !isNaN(parseFloat(res.data?.bioFuel)) && !isNaN(res.data?.bioFuel - 0) ? parseFloat(Number(res.data?.bioFuel)?.toFixed(2)) : res.data?.bioFuel,
        });
